...
EthernetSupport::EthernetSupport(EthernetServer& server) : server_(server) {}

void EthernetSupport::ServerBegin(byte mac[]) {
...
int EthernetSupport::EthernetParser(int U_set, double U_current) {
...
int EthernetSupport::GetVotageFromStr() {
  String tmp_str;
...
void EthernetSupport::PageRender(EthernetClient& client) {
